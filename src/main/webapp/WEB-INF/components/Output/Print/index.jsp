			...
			<div>
				...
				<form name="outputTypeForm" action="/project/page07" method="post">
						<ul role="tablist" id="outputTypes" style="display: block; float: left;" class="helpULHeader">
							<li id="printTabCnt" class="headingTabs floatL active" role="tab" tabindex="0" aria-labelledby="outputPrintTab" aria-controls="aoutputPrintTab" aria-selected="true">
...
<script src="/src/assets/js/outputpagepagebottom.js"></script>
...
<script src="/src/assets/js/citationexport.js"></script>
<script src="/src/assets/js/outputpagepagetop.js"></script>
