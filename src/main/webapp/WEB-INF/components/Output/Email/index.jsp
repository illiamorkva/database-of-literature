...
<div id="container"> 
	...
	<div id="sciverseCanvasArea" class="searchContent">
		...
		<div class="outputOuterCnt">	
			<div>
				<div class="firstbox">
				<form name="outputTypeForm" action="/project/page07-2" method="post">
						<ul role="tablist" id="outputTypes" style="display: block; float: left;" class="helpULHeader">
							...
							<li id="emailTabCnt" class="headingTabs floatL active" role="tab" tabindex="0" aria-labelledby="outputEmailTab" aria-controls="aoutputEmailTab" aria-selected="true">
...
<div id="outPutPrint">		
	<div id="export" class="export displayNone" style="display: none;">
		<form id="exportForm" name="ExportForm" action="/project/page07-2" method="post">
...
<div id="print" class="print displayNone">
	<form id="printForm" name="PrintForm" action="/project/page07-2" method="post">
...
<div id="email" class="email displayNone" style="display: block;">
	<form id="emailForm" name="EmailForm" action="/project/page07-2" method="post">
		<input id="sid" name="sid" type="hidden" value="">
		<input id="src" name="src" value="s" type="hidden">
		<input id="origin" name="origin" value="recordpage" type="hidden">
		<input id="sort" name="sort" type="hidden" value="">
...
<div id="quikbib" style="display:none" class="secondBox searchFieldsection">
	...
	<form id="quikbibForm" name="QuikbibForm" action="/project/page07-2" method="post">
		<input id="origin" name="origin" value="recordpage" type="hidden">
		<input id="sid" name="sid" type="hidden" value="">
		<input id="src" name="src" value="s" type="hidden">
		<input id="stateKey" name="stateKey" value="OFD_742374949" type="hidden">
...
<script language="javascript" type="text/javascript">
	contentType = '0';
	changeContentSectionValue('email');
</script>            
</div>
</div>
